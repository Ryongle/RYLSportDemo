...
#import "NSArray+RYLAddition.h"
#import "NSObject+RYLAddition.h"

@implementation NSArray (RYLAddition)

+ (NSArray *)r_objectListWithPlistName:(NSString *)plistName clsName:(NSString *)clsName {
    ...
    for (NSDictionary *dict in list) {
        [arrayM addObject:[cls r_objectWithDict:dict]];
    }
